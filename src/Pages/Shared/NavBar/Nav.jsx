  ...
  const navOptions = (
    <>
      <li>
        <Link
          to="/"
          className={`border ${activeButton === "home" ? "active" : ""}`}
      ...
      <li>
        <Link
          to="/colleges"
          className={`border ${activeButton === "colleges" ? "active" : ""}`}
          onClick={() => handleButtonClick("colleges")}
        >
          Colleges
        </Link>
      </li>
      <li>
        <Link
          to="/admission"
          className={`border ${activeButton === "admission" ? "active" : ""}`}
      ...
      {user && (
        <li>
          <Link
            to="/mycollege"
            className={`border ${activeButton === "mycollege" ? "active" : ""}`}
            onClick={() => handleButtonClick("mycollege")}
          >
            My College
          </Link>
        </li>
    ...
    <div className=" w-full">
      <div className="fixed top-0 z-10 max-w-screen-2xl navbar bg-opacity-30 text-white mxa backdrop-blur-md bg-black rounded-lg">
        <div className="navbar-start">
          ...
          <p className="text-xl md:text-3xl font-bold">EduJive</p>
        </div>
        ...
        <div className="navbar-end">
          {user ? (
            ...
            <>
              <Link
                className=" border bg-white hover:bg-black bg-opacity-10  backdrop-blur-md px-5 py-2 rounded-2xl "
                to="/login"
              >
                Login
              </Link>
